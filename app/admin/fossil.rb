  ...
  form do |f|
    f.inputs "Project Details" do
      ...
      div class: 'form-tax-select' do 
        f.collection_select(:kingdom_id, Kingdom.order(:kingdom_name), :id, :kingdom_name, include_blank: 'Kingdom', :required => true)  
        
        f.grouped_collection_select(:phylum_id, Kingdom.order(:kingdom_name), :phylums, :kingdom_name, :id, :phylum_name, :required => true)
