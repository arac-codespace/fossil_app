...
$(document).on "turbolinks:load", ->
	...
	$('#fossil_phylum_id').hide()
	$('#fossil_fossil_class_id').hide()
	$('#fossil_order_id').hide()
	$('#fossil_family_id').hide()
	$('#fossil_genera_id').hide()
	...
	$('#fossil_kingdom_id').change ->
		...
		if options
			...
			$('#fossil_phylum_id').html(options).prepend('<option selected="selected"> Phylum </option>')
			# Show phylum list
			$('#fossil_phylum_id').show()
	...
	$('#fossil_phylum_id').change ->
		...
		if options
			$('#fossil_fossil_class_id').html(options).prepend('<option selected="selected"> Class </option>')
			$('#fossil_fossil_class_id').show()
			$('#fossil_order_id').hide()				
			$('#fossil_order_id').empty()	
			$('#fossil_family_id').hide()				
			$('#fossil_family_id').empty()
	...
	$('#fossil_fossil_class_id').change ->
		...
		if options
			$('#fossil_order_id').html(options).prepend('<option selected="selected"> Order </option>')
			$('#fossil_order_id').show()
			$('#fossil_family_id').hide()				
			$('#fossil_family_id').empty()
			$('#fossil_genera_id').hide()				
			$('#fossil_genera_id').empty()			
	...
	$('#fossil_order_id').change ->
		...
		if options
			$('#fossil_family_id').html(options).prepend('<option selected="selected"> Family </option>')
			$('#fossil_family_id').show()
			$('#fossil_genera_id').hide()				
			$('#fossil_genera_id').empty()			
		else
			$('#fossil_family_id').empty()
	...
	$('#fossil_family_id').change ->
		...
		if options
			$('#fossil_genera_id').html(options).prepend('<option selected="selected"> Genus </option>')
			$('#fossil_genera_id').show()
		else
			$('#fossil_genera_id').empty()
			$('#fossil_genera_id').hide()				