...
# # # Kingdom table
# Kingdom.where(kingdom_name: 'Animalia').first_or_create!
# Kingdom.where(kingdom_name: 'Protozoa').first_or_create!
...
#   Phylum.where(x).first_or_create
# end
...
#   FossilClass.where(x).first_or_create
# end
...
#   Family.where(x).first_or_create
# end
...
# {genus_name: "Camarotoechia", kingdom_id: animalia.id, phylum_id: brachiopoda.id, fossil_class_id: rhynchonellata.id, order_id: rhynchonellida.id, family_id: camarotoechiidae.id},
...
# {genus_name: "Eutrephoceras", kingdom_id: animalia.id, phylum_id: mollusca.id, fossil_class_id: cephalopoda.id, order_id: nautilida.id, family_id: nautilidae.id},
...
#   Genera.where(x).first_or_create
# end
